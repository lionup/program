*Program: match_ind3_occ1_flows_edu.do
*Date 5/April/2012
...
log using log_match_ind3_occ1_flows_edu, text replace
...
* flows conditional on the eduction category of last month
	  ...
	  * calculate the rates from the levels
      ...
      if `x' >= 197603 {
        append using ../result/ind3_occ1_flows_edu.dta
      }
      saveold ../result/ind3_occ1_flows_edu.dta, replace
	}	
  }
