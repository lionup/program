*Program: match_ind2_occ3_flows.do
*Date 5/April/2012

***************************************************************************************
* THIS PROGRAM CREATES TRANSITION BETWEEN 2-DIGIT INDUSTRY AND 3-DIGIT OCCUPATION PAIR*
***************************************************************************************
set more 1

log using log_match_ind2_occ3_flows, text replace
...
* keep only the records at least 16 years old and with no missing value on industry and occupation in both months
      ...
      drop if occ1990_0 == . | dind7090_0 == . | occ1990_1 == . | dind7090_1 == .

* create sorting variable "indOcc2" categoried by industry and occupation
      tostring occ1990_0, gen(occ2_0)
      tostring dind7090_0, gen(ind2_0)
      tostring occ1990_1, gen(occ2_1)
      tostring dind7090_1, gen(ind2_1)
      
      replace occ2_0 = "o" + occ2_0
      replace ind2_0 = "i" + ind2_0
      gen str7 indOcc0 = ind2_0 + occ2_0
      
      replace occ2_1 = "o" + occ2_1
      replace ind2_1 = "i" + ind2_1
      gen str7 indOcc1 = ind2_1 + occ2_1
      
      gen str15 indOcc2 = indOcc0 + "_" + indOcc1
      sort indOcc2
      ...
      if `x' >= 197603 {
        append using ../result/ind2_occ3_flows.dta
      }
    
	  saveold ../result/ind2_occ3_flows.dta, replace
