*Program: match_ind3_occ2_flows.do
*Date 5/April/2012

***************************************************************************************
* THIS PROGRAM CREATES TRANSITION BETWEEN 3-DIGIT INDUSTRY AND 1-DIGIT OCCUPATION PAIR*
***************************************************************************************
set more 1

log using log_match_ind3_occ2_flows, text replace
...
* keep only the records at least 16 years old and with no missing value on industry and occupation in both months
      ...
      drop if docc1990_0 == . | ind7090_0 == . | docc1990_1 == . | ind7090_1 == .
...
* create sorting variable "indOcc2" categoried by industry and occupation
    ...
    if `x' >= 197603 {
      append using ../result/ind3_occ2_flows.dta
    }
    
	saveold ../result/ind3_occ2_flows.dta, replace
