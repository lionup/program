*Program: match_ind2_occ2_flows.do
*Date 5/April/2012
...
log using log_match_ind2_occ2_flows, text replace
...
* create sorting variable "indOcc2" categoried by industry and occupation
    ...
    if `x' >= 197603 {
      append using ../result/ind2_occ2_flows.dta
    }
    
	saveold ../result/ind2_occ2_flows.dta, replace
