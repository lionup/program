*Program: match_ind1_occ3_flows.do
*Date 5/April/2012

***************************************************************************************
* THIS PROGRAM CREATES TRANSITION BETWEEN 1-DIGIT INDUSTRY AND 3-DIGIT OCCUPATION PAIR*
***************************************************************************************

set more 1

log using log_match_ind1_occ3_flows, text replace
...
* create sorting variable "indOcc2" categoried by industry and occupation
      ...
      if `x' >= 197603 {
        append using ../result/ind1_occ3_flows.dta
      }
    
	  saveold ../result/ind1_occ3_flows.dta, replace
