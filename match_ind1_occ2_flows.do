*Program: match_ind1_occ2_flows.do
*Date 5/April/2012

***************************************************************************************
* THIS PROGRAM CREATES TRANSITION BETWEEN 1-DIGIT INDUSTRY AND 2-DIGIT OCCUPATION PAIR*
***************************************************************************************

set more 1

log using log_match_ind1_occ2_flows, text replace
...
* keep only the records at least 16 years old and with no missing value on industry and occupation in both months
      ...
      drop if docc1990_0 == . | mind7090_0 == . | docc1990_1 == . | mind7090_1 == .
...
* create sorting variable "indOcc2" categoried by industry and occupation
      ...
      if `x' >= 197603 {
        append using ../result/ind1_occ2_flows.dta
      }
      saveold ../result/ind1_occ2_flows.dta, replace
	}	
  }
