*Program: match_indv_occ3_flows.do
*Date 5/April/2012

***********************************************************************************
* THIS PROGRAM CREATES TRANSITION BETWEEN BEA INDUSTRY AND 3-DIGIT OCCUPATION PAIR*
***********************************************************************************

set more 1

log using log_match_indv_occ3_flows, text replace
...
* keep only the records at least 16 years old and with no missing value on industry and occupation in both months
      ...
      drop if occ1990_0 == . | vind7090_0 == . | occ1990_1 == . | vind7090_1 == .
...
* create sorting variable "indOcc2" categoried by industry and occupation
      ...
      drop monthsum
    if `x' >= 197603 {
      append using ../result/indv_occ3_flows.dta
    }
    
	saveold ../result/indv_occ3_flows.dta, replace
