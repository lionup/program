*Program: match_ind2_occ1_flows.do
*Date 5/April/2012

***************************************************************************************
* THIS PROGRAM CREATES TRANSITION BETWEEN 2-DIGIT INDUSTRY AND 1-DIGIT OCCUPATION PAIR*
***************************************************************************************

set more 1

log using log_match_ind2_occ1_flows, text replace
...
* keep only the records at least 16 years old and with no missing value on industry and occupation in both months
      ...
      drop if mocc1990_0 == . | dind7090_0 == . | mocc1990_1 == . | dind7090_1 == .
...
* create sorting variable "indOcc2" categoried by industry and occupation
	  ...
	  if `x' >= 197603 {
        append using ../result/ind2_occ1_flows.dta
      }
    
    	saveold ../result/ind2_occ1_flows.dta, replace
	}
