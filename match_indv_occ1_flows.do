*Program: match_indv_occ1_flows.do
*Date 5/April/2012
...
log using log_match_indv_occ1_flows, text replace
...
* create sorting variable "indOcc2" categoried by industry and occupation
    ...
    if `x' >= 197603 {
      append using ../result/indv_occ1_flows.dta
    }
    
	saveold ../result/indv_occ1_flows.dta, replace
