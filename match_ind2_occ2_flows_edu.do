*Program: match_ind2_occ2_flows_edu.do
*Date 5/April/2012
...
log using log_match_ind2_occ2_flows_edu, text replace
...
* keep only the records at least 16 years old and with no missing value on industry and occupation in both months
      ...
      drop if docc1990_0 == . | dind7090_0 == . | docc1990_1 == . | dind7090_1 == .
...
* flows conditional on the eduction category of last month
	  ...
	  * calculate the rates from the levels
      ...
      if `x' >= 197603 {
        append using ../result/ind2_occ2_flows_edu.dta
      }
      saveold ../result/ind2_occ2_flows_edu.dta, replace
	}	
  }
